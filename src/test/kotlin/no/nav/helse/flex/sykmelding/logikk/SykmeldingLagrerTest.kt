...
@SpringBootTest(
    properties = ["spring.kafka.listener.auto-startup=false", "spring.flyway.enabled=false", "spring.datasource.url=", "AAREG_URL=url", "EREG_URL=url"],
...
class SykmeldingLagrerTest {
    ...
    fun `burde lagre sykmelding fra kafka`() {
        ...
        val lagretSykmelding = sykmeldingRepository.findBySykmeldingUuid(sykmeldingMedBehandlingsutfall.sykmelding.id)
